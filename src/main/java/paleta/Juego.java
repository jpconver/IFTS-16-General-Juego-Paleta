...
public class Juego extends JComponent implements KeyListener, Runnable {
	...
	/* Actualizar la actualizacion y el dibujado del juego de esta forma no es recomendable dado que tendra distintas velocidades en distinto hardware
	 * Se hizo asi por simplicidad para facilitar el aprendizaje
	 * Lo recomendado es separar la parte de dibujado de la de actualizacion y usar interpolation
	 */
	@Override
	public void run() {
